<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    <li class="nav-item" id="dashboardMenuLink">
    ...
    <li class="nav-item">
      <a class="nav-link" href="cultos.php">
        <i class="mdi mdi-church menu-icon"></i>
        <span class="menu-title">Cultos</span>
      </a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="supervisores.php">
    ...
    <li class="nav-item">
      <a class="nav-link" href="participacao.php">
        <i class="mdi mdi-chart-pie menu-icon"></i>
        <span class="menu-title">Participação</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="pastor_zona.php">
        <i class="mdi mdi-calendar menu-icon"></i>
        <span class="menu-title">Pastores</span>
      </a>
    </li>
    <!--<li class="nav-item">
    ...
    <!-- <li class="nav-item">
      <a  class="nav-link" href="../index.php">
        <i class="menu-icon mdi user-icon"></i>
